...
import odogwu from "./ODOGWU (1).svg";
...
//   { name: "Update Details", href: "/update/", onClick:edit, current: false },
// ];
...
// const edit = (e, _id) => editCustomer(e, customers._id);
...
export default function UserView2() {
  ...
  //   e.preventDefault();
  //   // navigate("/customerupdateadmin");
  //   window.location.href = `/update/${customers._id}`
  // };
  ...
  const navigation = [
    ...
    { name: "Transaction History", href: "#", current: false },
    { name: "Financing Options", href: "#", current: false },
    // { name: "Update Details", href:`/update/${customers._id}`, current: false },
    { name: "Update Details", href:`/update/${customers.id}`, current: false },
  ];
  const userNavigation = [
    { name: "Your Profile", href: "#" },
    { name: "Settings", href: "#" },
        ...
        <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">
              {customers.firstName}'s Dashboard
            </h1>
          </div>
        </header>
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            {<UserView customers={customers} />}
          </div>
        </main>
      </div>
      <Footer />
